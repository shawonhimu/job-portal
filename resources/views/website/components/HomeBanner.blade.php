        ...
        <div class="container">
            <div class="personalBanner">
                <div class="row alignItems">
                    <div class="col-lg-6 sideCol">
                        <div class="personalDetails px-lg-4 mb-3 mb-lg-0 p-3 text-lg-start">
                            <div class="jobTitleArea">
                                <div class="loginLogo mobileViewOnly">
                                    <img src="./img/logo.png" alt="" srcset="" />
                                </div>
                                <!-- <div class="loginLogo">
                                    <img src="./img/logo.png" alt="" srcset="" />
                                </div> -->
                                <h1 class="jobTitle">Job Pulse</h1>
                    ...
                    <div class="col-lg-6">
                        <div class="">
                            <div class="frontBanner">
                                <img class="" src="./img/inspiration.svg" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
