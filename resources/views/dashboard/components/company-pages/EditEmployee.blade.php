                    ...
                    <div class="mt-3 newCard p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="firstName" class="form-control" id="empfirstname"
                                placeholder="Enter Firstname" required value="{{ $data->first_name }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="lastName" class="form-control" id="emplastname"
                                placeholder="Enter Lastname" required value="{{ $data->last_name }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="designation" class="form-control" id="empDesignation"
                                placeholder="Enter Firstname" required value="{{ $data->designation }}">
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Employee email </label>
                            <input type="email" name="email" class="form-control" id="email"
                                placeholder="Enter Firstname" required value="{{ $data->email }}">
                        </div>
                        <div class="mb-3">
                            <label for="phone" class="form-label">Employee phone </label>
                            <input type="number" name="phone" class="form-control" id="phone"
                                placeholder="Enter Firstname" required value="{{ $data->phone }}">
                        </div>
                        <div class="mb-3">
                            <label for="empAddress" class="form-label">Address </label>
                            <textarea name="address" class="form-control" id="empAddress" rows="3" required>{{ $data->address }}</textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password" class="form-control" id="empPassword"
                                placeholder="Enter password or generate" required value="{{ $data->first_name }}">
                        </div>
